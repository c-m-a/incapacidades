...
urlpatterns = [
    ...
    path('b/personas/', views.buscar_personas, name='buscar_persona'),
    path('b/personas/movimientos/', views.buscar_personas_movimientos, name='buscar_personas_movimientos'),
]
